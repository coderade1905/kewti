...
export default function Calnder () {
  ...
  return (
    ...
    <div className="  w-full bg-[#241B17] flex flex-col md:flex-row justify-between relative overflow-hidden font-sans p-0 md:p-0 m-0 select-none">
      
      {/* ================= LEFT COLUMN: CALENDAR BLOCK ================= */}
      <div className="w-full md:w-[32%] bg-[#1C1C1C]/40 flex items-center justify-center py-10 md:py-0 md:pl-6">
      ...
      <div className="w-full md:w-[34%] bg-[#211814] flex flex-col justify-center items-center py-16 md:py-0 px-4">
        <div className="w-full max-w-[380px] flex flex-col gap-3 relative">
      ...
      <div className="w-full md:w-[34%] bg-[#1C1C1C]/10 flex flex-col justify-between items-end relative pb-24 md:pb-0">
        
        {/* Country Selector Component Deck */}
        <div className="w-full max-w-[380px] bg-[#141414] rounded-xl border border-neutral-800/60 mt-8 md:mt-32 mx-4 md:mr-8 md:ml-0 overflow-hidden flex flex-col">
          ...
          <div className="flex relative">
            ...
            {/* Custom Orange Vertical Scrollbar */}
        ...
        <div className="bg-[#1C1C1C] rounded-none px-6 py-4 flex items-center gap-4 border-l border-t border-neutral-800/30 cursor-pointer hover:bg-[#2a2220] transition-colors w-full md:w-auto md:absolute md:bottom-0 md:right-0 md:rounded-none">
