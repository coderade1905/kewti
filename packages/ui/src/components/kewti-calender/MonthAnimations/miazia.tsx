...
export default function Miazia() {
  return (
    <motion.svg
      viewBox="0 0 756.213 756.213"
      style={{ originX: "0px", originY: "20px", marginTop: "10px" }}
      animate={{ scale: [1, 1.03, 1] }}
      transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
    >
      <g>
        {/* Overlapping Wedding Rings */}
        <motion.path
          d="M173.684,493.875c39.216,0,75.324-13.225,104.423-35.229c29.108,22.014,65.206,35.229,104.422,35.229
          ...
          fill="#FBBF24"
          animate={{ fill: ["#FBBF24", "#FDE047", "#FBBF24"] }}
          transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
        />

        {/* Ribbon / Bow Decoration */}
        <motion.path
          d="M274.75,77.868h-0.191c0,0-26.431-28.946-49.496-7.803c-23.065,21.143-2.888,69.854,49.496,90.997l0.191,0.182
                    c52.374-21.143,72.56-70.036,49.495-91.178C301.181,48.922,274.75,77.868,274.75,77.868z"
          fill="#EC4899"
          style={{ originX: "274px", originY: "77px" }}
