...
Kewti components are CLI-driven and copy-paste ready. When you install a component, `npx kewti` downloads the source code directly into your project's `src/kewti/ui/` directory, giving you full ownership and control.
...
Use the `npx kewti` CLI to add components directly to your project codebase:
